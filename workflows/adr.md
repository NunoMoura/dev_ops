...
1. Check for existing ADRs in `dev_docs/adrs/` to ensure no conflicts exist.
...
4. The script will generate an ADR ID (e.g., `ADR-XXX`) and create the file in `dev_docs/adrs/`.
...
- [ ] New ADR file created in `dev_docs/adrs/`.
