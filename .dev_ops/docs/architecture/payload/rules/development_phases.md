---
title: "{payload / rules / development_phases}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{payload/rules/development_phases}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {payload / rules / development_phases}
...
<!-- Found 5 files: 3_plan.md, 2_understand.md, 1_backlog.md, 4_build.md, 5_verify.md -->
