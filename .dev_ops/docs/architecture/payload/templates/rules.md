---
title: "{payload / templates / rules}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{payload/templates/rules}"       # Path to the thing being documented
...
<!-- Found 4 files: linters.md, languages.md, databases.md, libraries.md -->
