---
title: "{extension / resources}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/resources}"       # Path to the thing being documented
...
<!-- Found 5 files: metrics-icon.svg, board-icon.svg, docs-icon.svg, agent-icon.svg, devops-logo.png -->
