---
title: "{extension / .vscode}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/.vscode}"       # Path to the thing being documented
...
<!-- Found 4 files: launch.json, settings.json, extensions.json, tasks.json -->
