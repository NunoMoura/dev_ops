---
title: "{extension / src / core}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/core}"       # Path to the thing being documented
...
<!-- Found 4 files: types.ts, logger.ts, errors.ts, index.ts -->
