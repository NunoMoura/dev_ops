---
title: "{extension / src / ui / statusBar}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/ui/statusBar}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / ui / statusBar}
...
<!-- Found 2 files: statusBar.ts, index.ts -->
