---
title: "{extension / src / ui / dashboard}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/ui/dashboard}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / ui / dashboard}
...
<!-- Found 2 files: DashboardViewProvider.ts, index.ts -->
