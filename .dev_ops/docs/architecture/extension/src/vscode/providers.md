---
title: "{extension / src / vscode / providers}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/vscode/providers}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / vscode / providers}
...
<!-- Found 2 files: codeLensProvider.ts, actionProviders.ts -->
