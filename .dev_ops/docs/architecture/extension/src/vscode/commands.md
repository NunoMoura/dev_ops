---
title: "{extension / src / vscode / commands}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/vscode/commands}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / vscode / commands}
...
<!-- Found 9 files: sharedHandlers.ts, utils.ts, taskCommands.ts, initializeCommand.ts, workflowCommands.ts... -->
