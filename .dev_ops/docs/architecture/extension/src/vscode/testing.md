---
title: "{extension / src / vscode / testing}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/vscode/testing}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / vscode / testing}
...
<!-- Found 1 files: testController.ts -->
