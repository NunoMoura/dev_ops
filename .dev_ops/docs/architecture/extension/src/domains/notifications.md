---
title: "{extension / src / domains / notifications}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/domains/notifications}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / domains / notifications}
...
<!-- Found 3 files: phaseNotifications.ts, handoffNotifications.ts, index.ts -->
