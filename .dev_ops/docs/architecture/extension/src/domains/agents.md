---
title: "{extension / src / domains / agents}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/domains/agents}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / domains / agents}
...
<!-- Found 5 files: CursorAdapter.ts, AgentManager.ts, AgentAdapter.ts, index.ts, AntigravityAdapter.ts -->
