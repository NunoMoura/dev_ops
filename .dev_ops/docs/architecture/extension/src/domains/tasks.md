---
title: "{extension / src / domains / tasks}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/domains/tasks}"       # Path to the thing being documented
status: undocumented   # undocumented | draft | complete
coverage: 0            # Test coverage percentage (0-100)
---

# {extension / src / domains / tasks}
...
<!-- Found 5 files: filters.ts, taskPresentation.ts, taskUtils.ts, taskAccess.ts, index.ts -->
