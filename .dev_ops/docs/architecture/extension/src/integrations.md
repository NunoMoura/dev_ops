---
title: "{extension / src / integrations}"     # Descriptive document title
type: doc
lifecycle: persistent  # Documents are persistent across tasks
path: "{extension/src/integrations}"       # Path to the thing being documented
...
<!-- Found 3 files: environment.ts, sessionBridge.ts, cursorBridge.ts -->
